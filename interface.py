...
class Interface:
    ...
    def menu_initialisation(self):
        ...
        menuContrast = tk.Menu(self.menubar, tearoff=0,bg='#696969')
        ...
        menuFilter = tk.Menu(self.menubar, tearoff=0,bg='#696969')
        ...
        menuBinary = tk.Menu(self.menubar, tearoff=0,bg='#696969')
        ...
        menuColour = tk.Menu(self.menubar, tearoff=0,bg='#696969')
        ...
        menuOther = tk.Menu(self.menubar, tearoff=0,bg='#696969')
        ...
        self.window.config(menu=self.menubar,bg='#696969')

        Frametools = tk.Frame(self.window, width=self.window.winfo_screenwidth() * 0.3,bg='#000000')
        Frametools.pack_propagate(0)
        Frametools.pack(anchor=tk.W, side=tk.LEFT, fill=tk.Y, expand=tk.YES)

        FrameFile = tk.Frame(Frametools, height=100, width=100, pady=5,bg='#000000')
        tk.Label(FrameFile, text="Image Path:",bg='#000000',fg='white').grid(row=0, column=0, padx=2)
        self.entry_text = tk.StringVar()
        self.entry_text.set("input/chat.pgm")
        tk.Entry(FrameFile, width=30, textvariable=self.entry_text,bg='#696969',fg='white').grid(row=0, column=1, padx=10)
        FrameFile.pack(anchor=tk.NW)

        Frameopensave = tk.Frame(Frametools, height=100, width=100, pady=5,bg='#000000')
        tk.Button(Frameopensave, text="Open", padx=10, pady=5,bg='#000000',fg='white', command=self.openButton_callback).grid(row=0, column=0,
                                                                                                      padx=10)
        tk.Button(Frameopensave, text="Save", padx=10, pady=5,bg='#000000',fg='white', command=self.saveButton_callback).grid(row=0, column=1,
                                                                                                      padx=10)
        self.original_button = tk.Button(Frameopensave, text="Original",bg='#000000',fg='white', state=tk.DISABLED, padx=10, pady=5,
                                         command=self.originalButton_callback)
        self.original_button.grid(row=0, column=2, padx=10)
        self.undo_button = tk.Button(Frameopensave, text="Undo", state=tk.DISABLED, padx=10, pady=5,bg='#000000',fg='white',
        ...
        Framesize = tk.Frame(Frametools, height=100, width=100, pady=5,bg='#000000')
        tk.Label(Framesize, text="Size of filters,local equalisation and binary operations: ",bg='#000000',fg='white').grid(row=0, column=0,
                                                                                                   padx=10)
        self.size_num = tk.Spinbox(Framesize, width=3, from_=3, to=29, increment=2,bg='#696969',fg='white')
        self.size_num.grid(row=0, column=2)
        Framesize.pack(anchor=tk.NW)

        Framethreshold = tk.Frame(Frametools, height=100, width=100, pady=5,bg='#000000')
        tk.Label(Framethreshold, text="Manual threshold value: ",bg='#000000',fg='white').grid(row=0, column=0, padx=10)
        self.thresh_slider = tk.Scale(Framethreshold, from_=0, to=0,length=150,tickinterval=0, orient=tk.HORIZONTAL,bg='#696969',fg='white')
        self.thresh_slider.grid(row=0, column=2)
        Framethreshold.pack(anchor=tk.NW)

        ttk.Separator(Frametools, orient='horizontal').pack(fill='x', pady=5)
        tk.Label(Frametools, text="Image properties:",bg='#000000',fg='white').pack(anchor=tk.NW)

        Framewidth = tk.Frame(Frametools, height=100, width=100, pady=5,bg='#000000')
        tk.Label(Framewidth, text="Width:",bg='#000000',fg='white').grid(row=0, column=0, padx=10)
        self.width_text = tk.Label(Framewidth, text="0", width=15, relief=tk.SUNKEN,bg='#696969',fg='white')
        self.width_text.grid(row=0, column=2)
        Framewidth.pack(anchor=tk.NW)

        Frameheight = tk.Frame(Frametools, height=100, width=100, pady=5,bg='#000000')
        tk.Label(Frameheight, text="Length:",bg='#000000',fg='white').grid(row=0, column=0, padx=10)
        self.height_text = tk.Label(Frameheight, text="0", width=15, relief=tk.SUNKEN,bg='#696969',fg='white')
        self.height_text.grid(row=0, column=2)
        Frameheight.pack(anchor=tk.NW)

        Framepixel = tk.Frame(Frametools, height=100, width=100, pady=5,bg='#000000')
        tk.Label(Framepixel, text="Number of pixels:",bg='#000000',fg='white').grid(row=0, column=0, padx=10)
        self.pixel_text = tk.Label(Framepixel, text="0", width=15, relief=tk.SUNKEN,bg='#696969',fg='white')
        self.pixel_text.grid(row=0, column=2)
        Framepixel.pack(anchor=tk.NW)

        ttk.Separator(Frametools, orient='horizontal').pack(fill='x', pady=5)
        tk.Label(Frametools, text="Image stats:",bg='#000000',fg='white').pack(anchor=tk.NW)

        Frameaverage = tk.Frame(Frametools, height=100, width=100, pady=5,bg='#000000')
        tk.Label(Frameaverage, text="Average:",bg='#000000',fg='white').grid(row=0, column=0, padx=10)
        self.average_text = tk.Label(Frameaverage, text="0", width=25, relief=tk.SUNKEN,bg='#696969',fg='white')
        self.average_text.grid(row=0, column=2)
        Frameaverage.pack(anchor=tk.NW)

        Framedeviation = tk.Frame(Frametools, height=100, width=100, pady=5,bg='#000000')
        tk.Label(Framedeviation, text="Standard deviation:",bg='#000000',fg='white').grid(row=0, column=0, padx=10)
        self.deviation_text = tk.Label(Framedeviation, text="0", width=25, relief=tk.SUNKEN,bg='#696969',fg='white')
        self.deviation_text.grid(row=0, column=2)
        Framedeviation.pack(anchor=tk.NW)
        Frameentropy = tk.Frame(Frametools, height=100, width=100, pady=5,bg='#000000')
        tk.Label(Frameentropy, text="Entropy:",bg='#000000',fg='white').grid(row=0, column=0, padx=10)
        self.entropy_text = tk.Label(Frameentropy, text="0", width=25, relief=tk.SUNKEN,bg='#696969',fg='white')
        self.entropy_text.grid(row=0, column=2)
        Frameentropy.pack(anchor=tk.NW)

        FrameSNR = tk.Frame(Frametools, height=100, width=100, pady=5,bg='#000000')
        tk.Label(FrameSNR, text="SNR:",bg='#000000',fg='white').grid(row=0, column=0, padx=10)
        self.SNR_text = tk.Label(FrameSNR, text="0", width=25, relief=tk.SUNKEN,bg='#696969',fg='white')
        self.SNR_text.grid(row=0, column=2)
        FrameSNR.pack(anchor=tk.NW)

        FrameHistogram = tk.Frame(Frametools, width=self.window.winfo_screenwidth() * 0.3, height=300, pady=5,bg='#000000')
        tk.Label(FrameHistogram, text="Histogram:",bg='#000000',fg='white').pack(padx=10)
        ...
        FrameConsole = tk.Frame(Frametools, height=100, width=100, pady=5,bg='#000000')
        ...
        self.imageframe = tk.Frame(self.window, width=self.window.winfo_screenwidth() * 0.7,bg='#696969')
    ...
    def displayImageColour(self):
        self.ax1.clear()
        self.ax1.imshow(self.currentimage)
        self.fig1.canvas.draw()
    ...
    def manual_transformation_window_callback(self):
        ...
        Framemain = tk.Frame(self.manualWindow,bg='#000000')
        Framemain.pack_propagate(0)
        Framemain.pack(anchor=tk.W, side=tk.LEFT, fill=tk.BOTH, expand=tk.YES)

        Framepoint = tk.Frame(Framemain, height=100, width=100, pady=5,bg='#000000')
